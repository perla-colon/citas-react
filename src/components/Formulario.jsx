    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form onSubmit={handleSubmit}
                ...
                <div className="mb-5">
                    <label className="block text-gray-700 uppercase" htmlFor="masota">Nombre Mascota: {nombre}</label>
                    <input  
                        id="mascota" 
                ...
                <div className="mb-5">
                    <label className="block text-gray-700 uppercase" htmlFor="sintomas">Síntomas:</label>
                    <textarea className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
                            name="sintomas" id="sintomas" cols="30" rows="10" 
